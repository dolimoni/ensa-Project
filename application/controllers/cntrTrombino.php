...
public function connexion()
	{ $this->load->model('ModelTrombino') ;
		...
		$this->form_validation->set_rules('AU', '"Année universitaire"','trim|required|encode_php_tags');
		$this->form_validation->set_rules('choix1', '"Choix de filière"','trim|required|encode_php_tags');
