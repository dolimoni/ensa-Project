...
//le w et le h de tte la page pdf
	...
	$pdf->Cell(200,7,'des élèves issus du CNC',0,1,'C');
	//verifier la date
	...
	//augmenter la valeur de x et y(selon w et h du rect precedent) du rect apres chacqe affichage pr obtenir un rect pr chaque personne 
	$xrect=4;
	$yrect=50;
