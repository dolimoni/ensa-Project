        ...
        <div id="e_signup">
            <div class="container">
                ...
                <div class="text-center">
                    ...
                    if($who == "ensa"){
                    ?>
                    <a href="<?php echo site_url('My_controllerpdf/pdfensasprepa')?>" class="btn btn-warning"><span class="glyphicon glyphicon-download-alt"></span> Générer PDF</a>
                    <?php
                    }elseif($who == "cnc"){
                    ?>
                    <a href="<?php echo site_url('My_controllerpdf/pdfelevescnc')?>" class="btn btn-warning"><span class="glyphicon glyphicon-download-alt"></span> Générer PDF</a>
                    <?php
                    }else{
                    ?>
                    <a href="<?php echo site_url('My_controllerpdf/pdfconcours')?>" class="btn btn-warning"><span class="glyphicon glyphicon-download-alt"></span> Générer PDF</a>
                    <?php
                    }
                    ?>
                    <a href="<?php echo site_url("etudiant_controller/deconnexion"); ?>" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Modifier</a>
                    ...
                    <br/>
                    <br/>
                    <img class="img-thumbnail" src="<?php echo img_url($cin.".jpg"); ?>" style="width:200px; height: 200px;" />
                </div>
                <div class="row">
